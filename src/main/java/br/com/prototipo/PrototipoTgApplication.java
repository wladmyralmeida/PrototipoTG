...
public class PrototipoTgApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Desempenho dp1 = new Desempenho(null, "4 Km de Corrida", "7 Km de Corrida", 45, 30, 4.5, 15, "Melhorar Abdominais", usu1);
		Desempenho dp2 = new Desempenho(null, "3 Séries de 5 Barras", "3 Séries de 8 Barras", 25, 100, 7.0, 10, "Melhorar Flexões", usu2);
		...
		Pagamento pgt2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("02/02/2019 12:00"), sdf.parse("01/01/2019 00:00"));
